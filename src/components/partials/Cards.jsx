...
{c.vote_average && (<div className=' absolute right-[-10%] bottom-[25%] rounded-full text-xl font-semibold  bg-yellow-600 text-white w-[7vh] h-[7vh] flex justify-center items-center '>{(c.vote_average*10).toFixed()} <sup>%</sup>
